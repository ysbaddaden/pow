(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    function Configuration(options) {
      ...
      this.hostRoot = (_ref20 = (_ref21 = options.hostRoot) != null ? _ref21 : env.POW_HOST_ROOT) != null ? _ref20 : libraryPath("Pow", "Hosts");
      this.logRoot = (_ref22 = (_ref23 = options.logRoot) != null ? _ref23 : env.POW_LOG_ROOT) != null ? _ref22 : libraryPath("Pow", "Logs");
  ...
  libraryPath = function() {
    ...
    return path.join.apply(path, [env.HOME, ".config"].concat(__slice.call(args)));
  };
